package com.dmhashanmd.slpd.login.controller;
...
import com.dmhashanmd.slpd.login.model.LoginModel;
import com.dmhashanmd.slpd.login.view.LoginActivity;
...
public class LoginController {
    ...
    public LoginController(LoginActivity mainActivity) {
